...
HINSTANCE hInst;
WCHAR szAppName[] = L"RtfEditApp";
WCHAR szAppTitle[] = L"Rich Text Editor RtfPad";
HWND hwndEdit;
HINSTANCE hRTFLib;
    ...
    HWND hwndCtl, UINT codeNotify)
{
    ...
    case ID_HELP_ABOUT:
        MessageBox(hWnd,
            L"Rich Text Editor RtfPad, v.1.0\n"
            L"(C) Alexandr Frolov, 1995\n"
            L"Email: frolov@glas.apc.org",
...
{
    OPENFILENAME ofn;
    WCHAR szFile[256] = L"untitled.rtf";
    WCHAR szDirName[512];
...
// -----------------------------------------------------
DWORD CALLBACK
SaveCallback(DWORD dwCookie, LPCCH pbBuff,
    LONG cb, LONG* pcb)
{
